-- starts da script dont modify this shit because its important
...
local ScriptHub = {
    ...
    { Name = "Arsenal", Description = "Script for Arsenal", LoadString = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/vylerascripts/vylera-scripts/main/arsenal2.lua"))()' },
    { Name = "Piano OP", Description = "Script PIANOOOOO", LoadString = 'pcall(function() loadstring(game:HttpGet("https://hellohellohell0.com/talentless-raw/TALENTLESS.lua", true))() end)' },
    { Name = "Plutonium AA", Description = "UMM JogOs?", LoadString = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/PawsThePaw/Plutonium.AA/refs/heads/main/Versions%202/V3.8.0.txt", true))()' },
...
local function OpenScriptHub()
    ...
    local Window = Library:CreateWindow({ Title = "Scripts" })
    ...
    for _, Script in ipairs(ScriptHub) do
        Window:AddButton({
            ...
            Tab = "Home",
            Callback = function()
                API:Notify({ Title = "idk", Description = "executed " .. Script.Name .. "...", Type = "Info", Duration = 3 })
...
Command.Add({
    Aliases = { "exec" },
    Description = "Executes Script (ex: ;exec solara)",
...
Command.Add({
    ...
    Task = function()
        ...
        Window:AddSection({ Title = " EMOTES IDS", Tab = "Home" })
...
Command.Add({
	...
	Task = function()
		...
		if (Tab) then
			...
			Window:AddTab({
				Title = "About",
				Description = "List of credits & information about Leaf Cmd",
				Tab = "Home",
			})

			Window:AddTab({
				Title = "Prefixes",
				Description = "Change the prefixes of Leaf Cmd",
				Tab = "Home",
			})
			...
			Window:AddTab({
				Title = "Theme",
				Description = "Customize the look of Leaf Cmd",
				Tab = "Home",
			})
			...
			Window:AddSection({ Title = "Leaf Cmd", Tab = "About" })
			...
			Window:AddParagraph({
				Title = "Command Count",
				Description = Format("Currently Leaf Cmd has %d commands", GetTableLength(Commands)),
				Tab = "About",
			})

			Window:AddParagraph({
				Title = "Discord",
				Description = "https://discord.gg/Leaf",
				Tab = "About",
			})
			...
			Window:AddToggle({
				...
				Description = "Toggle if Leaf Cmd should recommend commands",
				Tab = "Toggles",
...
Command.Add({
	...
	Description = "A simple tutorial to showcase how Leaf Cmd works",
	Arguments = {},
	Task = function()
		...
		if (Tab) then
			...
			Tutorial.Invite.Text = "https://discord.gg/leaf"
		end
	end,
})
...
Command.Add({
	...
	Description = "Displays all the commands Leaf Cmd has",
	Arguments = {},
	Task = function()
...
Command.Add({
	Aliases = { "invisible2", "invisgui" },
	Description = "Opens Invisible",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/NormalZyoherion/leaf-scripts/refs/heads/main/leaf2_invisible-obfuscated.lua.txt"))()
   end,
})

Command.Add({
	Aliases = { "wallhop", "hoponwall" },
	Description = "Opens Wallhop ui",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/NormalZyoherion/leaf-scripts/refs/heads/main/leaf-wallhop.luau"))()
      end,
})

Command.Add({
	Aliases = { "fly2", "tfly", "tweenfly" },
	Description = "Opens fly ui",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://github.com/NormalZyoherion/leaf-scripts/raw/main/fly.luau"))()
      end,
})

Command.Add({
	Aliases = { "noclip3", "noclipgui" },
	Description = "Opens noclip ui",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://github.com/NormalZyoherion/leaf-scripts/raw/main/Main.lua_17-obfuscated.lua.txt"))()
      end,
})

Command.Add({
	Aliases = { "dash", "dashgui" },
	Description = "Opens noclip ui",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://github.com/NormalZyoherion/leaf-scripts/raw/main/Main.lua_18-obfuscated.lua.txt"))()
      end,
})

Command.Add({
	Aliases = { "movement2", "move2" },
	Description = "Opens noclip ui",
	Arguments = {},
	Task = function()
		loadstring(game:HttpGet("https://github.com/NormalZyoherion/Roblox-Scripts-universal/raw/main/leaf-testing-movement.luau"))()
      end,
})
	...
	if (Settings.Toggles.Developer) then
		...
		if (Interface and API) then
			...
			API:Notify({
				...
				Description = "If you would like to reload Leaf Cmd rejoin or enable Developer mode!",
				Duration = 5,
				Type = "Error",
			})
...
API:Notify({
	Title = "Welcome to Leaf CMD %s",
	Description = Format(
		"Leaf was Loaded in %.2f seconds (Version %s)\nCommandBarPrefix: '%s'\nChat Prefix: '%s'\n<b>JOIN: %s</b>",
		tick() - Speed,
		Settings.Version,
		Settings.Prefix,
		Settings.ChatPrefix,
		"https://discord.gg/leaf"
	),
	Duration = 5,
	Type = "Info",
})
